...
public class DesignatorStatementOptionSecond extends DesignatorStatementOptions {

    private ActParsList ActParsList;

    public DesignatorStatementOptionSecond (ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementOptionSecond(\n");
